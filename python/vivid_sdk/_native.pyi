...
def presenter_start(
    endpoint: str,
    desktop: Optional[Tuple[int, int]] = ...,
    retained_bytes: Optional[int] = ...,
) -> Presenter: ...
def presenter_close(presenter: Presenter) -> None: ...
def presenter_issue_pane_capability(presenter: Presenter, pane: int) -> str: ...
def presenter_revoke_pane(presenter: Presenter, pane: int) -> None: ...
def presenter_update_metrics(
    presenter: Presenter,
    pane: int,
    columns: int,
    rows: int,
...
def presenter_wait_for_media(
    presenter: Presenter, pane: int, timeout_us: int
) -> bool: ...
def presenter_capture_pane(
    presenter: Presenter, pane: int, viewport_offset: int
) -> Dict[str, Any]: ...
def presenter_pane_media_summary(
    presenter: Presenter, pane: int
) -> Dict[str, Any]: ...
